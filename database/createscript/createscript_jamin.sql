...
-- *******       **********      ****************            ******************
-- 01            12-09-2025      Koen Geijtenbeek            New Database
-- **********************************************************************************/
...
-- Version       Date:           Author:                     Description:
-- *******       **********      ****************            ******************
-- 01            12-09-2025      Koen Geijtenbeek            New Table
-- **********************************************************************************/
...
-- Version       Date:           Author:                     Description:
-- *******       **********      ****************            ******************
-- 01            12-09-2025      Koen Geijtenbeek            New Data
-- **********************************************************************************/
...
(
    Id                  SMALLINT        UNSIGNED        NOT NULL    AUTO_INCREMENT
   ,Naam                VARCHAR(30)                     NOT NULL
   ,ContactPersoon      VARCHAR(40)                     NOT NULL
...
(
   ...
   ,AantalAanwezig      SMALLINT                            NULL    DEFAULT NULL
   ,IsActief            BIT                             NOT NULL    DEFAULT 1
   ,Opmerkingen         VARCHAR(250)                        NULL    DEFAULT NULL
   ,DatumAangemaakt     DateTime(6)                     NOT NULL    DEFAULT (SYSDATE(6))
   ,DatumGewijzigd      DateTime(6)                     NOT NULL    DEFAULT (SYSDATE(6))
